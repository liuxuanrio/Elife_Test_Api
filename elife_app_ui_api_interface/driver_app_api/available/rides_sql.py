...
class RidesSql:
    def initialize_ride(self):
        ...
        sqlList = [["update ride.dispatch set stat = '134217729', fleet_driver_id = null, meeting_place_id=null, "
                   ...
                   ["delete from ride.dispatch where to_fleet_id in ('11466','11468');"],
                   ["update ride.auction_ride set trip_no_x = 0 where auction_id in "
                    "(select auction_id from ride.auction_fleet where fleet_id = '11466' and auction_id != '3814');"],
...
if __name__ == "__main__":
    pass
    print(RidesSql().updateCountTime(1))